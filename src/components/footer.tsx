        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 pb-8">
          ...
          <div className="flex flex-col gap-0.2 text-white text-sm">
            <div className="flex items-center gap-4 cursor-pointer mb-5">
              ...
              >
                <path
                  d="M81.9624 32.1738L66.4352 57.396L73.1297 68.5603L96 32.1738H81.9624Z"
                  fill="url(#paint0_linear_67_29)"
                />
                <path
                  d="M14.0418 32.1738L43.2134 77.0989L35.7238 89.0001L0 32.1738H14.0418Z"
                  fill="url(#paint1_linear_67_29)"
                />
                <path
                  d="M72.9875 32.1737L49.0753 0L25.1632 32.1737L60.8829 89L68.3724 77.0987L56.0293 58.091L72.9875 32.1737ZM39.2009 32.1737L49.0753 18.4256L59.1297 32.1737L49.4561 47.9653L39.2009 32.1737Z"
                  fill="url(#paint2_linear_67_29)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_67_29"
                    x1="81.2176"
                    y1="32.1738"
                    x2="81.2176"
                    y2="68.5603"
              ...
              <span className="text-black logofont font-bohme font-bold text-[12px]">
                POWER WIN
              </span>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm md:text-base gap-6 text-center md:text-left">
          <div className="flex gap-4 flex-wrap justify-center">
            {[
              ...
              <div
                key={idx}
                className="rounded-md px-4 py-2 flex items-center justify-center shadow-md cursor-pointer hover:scale-105 transition-transform bg-white w-[60px] h-[33px]"
              >
                <img
              ...
              (Icon, idx) => (
                <div
                  ...
                  className="
                        ...
                        bg-gradient-to-b from-black via-[#121212] to-[#161616]
                        filter transition duration-200 hover:brightness-110
                        cursor-pointer
                    "
                >
